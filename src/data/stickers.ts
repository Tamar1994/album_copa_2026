...
const TEAMS: { abbrev: string; name: string }[] = [
  { abbrev: 'MEX', name: 'Mexico' },
  { abbrev: 'RSA', name: 'South Africa' },
  { abbrev: 'KOR', name: 'Korea Republic' },
  { abbrev: 'CZE', name: 'Czechia' },
  { abbrev: 'CAN', name: 'Canada' },
  { abbrev: 'BIH', name: 'Bosnia-Herzegovina' },
  { abbrev: 'QAT', name: 'Qatar' },
  { abbrev: 'SUI', name: 'Switzerland' },
  { abbrev: 'BRA', name: 'Brazil' },
  { abbrev: 'MAR', name: 'Morocco' },
  { abbrev: 'HAI', name: 'Haiti' },
  { abbrev: 'SCO', name: 'Scotland' },
  { abbrev: 'USA', name: 'USA' },
  { abbrev: 'PAR', name: 'Paraguay' },
  { abbrev: 'AUS', name: 'Australia' },
  { abbrev: 'TUR', name: 'Türkiye' },
  { abbrev: 'GER', name: 'Germany' },
  { abbrev: 'CUW', name: 'Curaçao' },
  { abbrev: 'CIV', name: "Cote d'Ivoire" },
  { abbrev: 'ECU', name: 'Ecuador' },
  { abbrev: 'NED', name: 'Netherlands' },
  { abbrev: 'JPN', name: 'Japan' },
  { abbrev: 'SWE', name: 'Sweden' },
  { abbrev: 'TUN', name: 'Tunisia' },
  { abbrev: 'BEL', name: 'Belgium' },
  { abbrev: 'EGY', name: 'Egypt' },
  { abbrev: 'IRN', name: 'IR Iran' },
  { abbrev: 'NZL', name: 'New Zealand' },
  { abbrev: 'ESP', name: 'Spain' },
  { abbrev: 'CPV', name: 'Cabo Verde' },
  { abbrev: 'KSA', name: 'Saudi Arabia' },
  { abbrev: 'URU', name: 'Uruguay' },
  { abbrev: 'FRA', name: 'France' },
  { abbrev: 'SEN', name: 'Senegal' },
  { abbrev: 'IRQ', name: 'Iraq' },
  { abbrev: 'NOR', name: 'Norway' },
  { abbrev: 'ARG', name: 'Argentina' },
  { abbrev: 'ALG', name: 'Algeria' },
  { abbrev: 'AUT', name: 'Austria' },
  { abbrev: 'JOR', name: 'Jordan' },
  { abbrev: 'POR', name: 'Portugal' },
  { abbrev: 'COD', name: 'Congo DR' },
  { abbrev: 'UZB', name: 'Uzbekistan' },
  { abbrev: 'COL', name: 'Colombia' },
  { abbrev: 'ENG', name: 'England' },
  { abbrev: 'CRO', name: 'Croatia' },
  { abbrev: 'GHA', name: 'Ghana' },
  { abbrev: 'PAN', name: 'Panama' },
];
